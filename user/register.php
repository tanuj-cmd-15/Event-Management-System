...
<body>
                ...
                <div class="brand">
                    <a href="#hero">
                        <h1 style="font-size: 3rem; color: white">
                            <span>D</span>YPC<span>O</span>E Student Registration
                        </h1>
                    </a>
                </div>
                <div class="nav-list">
    ...
    <section id="add" style="min-height: 130vh;">
        <div class="add container">
            <form action="" method="post">
                <label for="username">ENTER DYPCOE</label>
    ...
    <section id="footer">
        <div class="footer">
            ...
            <br />
            <p style="color: white">
                Copyrights &copy; All rights are Reserved DYPCOE <a style="color:rgb(41, 50, 60) ;"
